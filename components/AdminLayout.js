...
const menuItems = [
  ...
  { label: 'Students', href: '/admin/students', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z' },
  { label: 'Content', href: '/admin/content', icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z' },
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white px-6 py-5">
            ...
            <p className="text-gray-400 text-xs mt-0.5">Darul Uloom Bilaliya</p>
          </div>
          ...
          <div className="p-4 border-t border-gray-100">
            <Link
              href="/"
              className="flex items-center gap-2 text-sm text-gray-500 hover:text-emerald-600 transition-all"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white shadow-sm px-4 lg:px-8 py-4 flex items-center justify-between">
          ...
          {router.pathname === '/admin' && (
            <h1 className="text-xl font-bold text-gray-900 hidden lg:block">Dashboard</h1>
          )}
          <div className="ml-auto flex items-center gap-3">
            <Link
              href="/login"
              className="text-sm text-gray-500 hover:text-emerald-600 transition-all"
            >
              Logout
            </Link>
          </div>
